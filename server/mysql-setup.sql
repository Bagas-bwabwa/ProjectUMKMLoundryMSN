-- MySQL Database Setup for Laundry Management System
...
-- 6. Transaction Services (Many-to-Many relationship)
...
-- Password for sample users: 'password'
-- You should change this after initial setup
